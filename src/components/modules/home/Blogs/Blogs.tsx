...
const Blogs = () => {
    return (
        <section className="blogs-section">
            <div className="h-[350px] md:h-[400px] lg:h-[450px] bg-it-medium-dark px-2.5 pt-[45px] md:pt-[100px]">
                <div className="max-w-[1140px] flex flex-col gap-y-5 md:flex-row justify-center md:items-center gap-x-10 text-white mx-auto">
                    <h1 className="text-5xl md:text-[80px] lg:text-[110px] md:w-1/2 font-syne font-bold leading-[42px]">
                        Blogs
                    </h1>
                    <p className="text-[18px] text-[#DDDDDD] md:w-1/2 font-dm-sans">
                            ...
                            <SwiperSlide key={index}>
                                <div className="group md:max-w-[330px] lg:max-w-[280px] overflow-hidden relative">
                                    ...
                                    <div className="blog-content bg-white w-[90%] absolute bottom-0 left-0 py-5 px-[30px] group-hover:pb-[75px] transition-all duration-300">
                                        ...
                                        <Link href={`/blogs`}>
                                            <div className="h-[40px] w-[40px] flex justify-center items-center translate-y-[200px] group-hover:translate-y-[10px] transition-all duration-300 cursor-pointer border-[1px] border-[#DDDDDD] rounded-full hover:bg-it-primary hover:text-white absolute">
                                                <ArrowRight
                                                    strokeWidth={1.5}
                                                    size={20}
                                                />
