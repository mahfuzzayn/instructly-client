...
const HeroSection = ({ tutors }: { tutors: ITutor[] }) => {
    ...
    return (
        <section className="hero-section">
            <div className="text-it-medium-dark h-[540px] sm:h-[560px] relative overflow-hidden pt-36">
                ...
                <div className="tutors-image-container absolute -bottom-20 select-none pointer-events-none">
                    <Image
                        src={tutorsImage}
                        alt="Tutors Image"
                        className="mx-auto"
