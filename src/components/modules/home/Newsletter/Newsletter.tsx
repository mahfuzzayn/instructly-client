                        ...
                        <form onSubmit={handleSubmit(onSubmit)}>
                            <div className="flex">
                                ...
                                <Button
                                    ...
                                    className="bg-it-secondary text-white font-semibold px-6 py-3 rounded-lg rounded-l-none transition duration-300 hover:bg-it-medium-dark disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                    {isSubmitting
                                        ? "Subscribing..."
                                        : "Subscribe"}
